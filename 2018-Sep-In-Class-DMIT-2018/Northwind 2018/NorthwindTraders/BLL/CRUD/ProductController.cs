    ...
    public class ProductController
    {
        ...
        public List<Product> GetProductsByPartialProductName(string partialName)
        {
            using (var context = new NorthwindContext())
            {
                ...
                // using System.Data.Entity;
                return result.Include(nameof(Product.Category)) //Category of the product
                             .Include(nameof(Product.Supplier)) //Supplier of the product.Category
                             .ToList();
                //An example of a fluent set of interfaces
            }
        }
        ...
        //The deletes are overloaded methods
...
//Avoid repeating and duplicating code everywhere
